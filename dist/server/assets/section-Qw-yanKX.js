import { d as createLucideIcon, f as cn } from "./router-SqoSsefC.js";
import { r as reactExports, T as jsxRuntimeExports } from "./worker-entry-IXYjofTX.js";
const __iconNode = [
...
function Section({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.section,
    {
      className: cn("section-shell mx-auto max-w-7xl px-5 py-14 md:px-6 md:py-18", className),
      initial: { opacity: 0, y: 24 },
      whileInView: { opacity: 1, y: 0 },
      viewport: { once: true, amount: 0.2 },
      transition: { duration: 0.55, ease: [0.22, 1, 0.36, 1] },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: id2, className: "scroll-mt-24 mb-9 grid gap-4 md:grid-cols-[0.8fr_1.2fr] md:items-end", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            eyebrow && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "inline-flex items-center gap-2 bg-slate-950 px-3 py-1.5 font-mono text-[11px] uppercase tracking-[0.16em] text-cyan-200", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                className: eyebrow ? "mt-4 text-3xl font-black leading-tight md:text-[2.6rem]" : "text-3xl font-black leading-tight md:text-[2.6rem]",
                children: title
              }
            )
          ] }),
          description && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: eyebrow ? "max-w-xl text-sm leading-relaxed text-muted-foreground md:ml-auto md:text-base" : "max-w-xl text-sm leading-relaxed text-muted-foreground md:ml-auto md:text-base",
